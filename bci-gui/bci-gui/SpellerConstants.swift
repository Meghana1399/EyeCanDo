...
public class SpellerConstants {
    ...
    public static let EEG_SENSOR_TOTAL:Int = 8
    ...
    */
    ...
    public static let SAMPLING_RATE:Double = 256.0
    public static let FREQUENCY_SLICE_MAX:Double = 128.0 //half the sampling rate
